...
st.subheader("時間區間")
if choice == '台積電: 2022.1.1 至 2024.4.9':
    start_date = st.text_input('輸入開始日期(日期格式: 年-月-日), 區間:2022-01-01 至 2024-04-09', '2022-01-01')
    end_date = st.text_input('輸入結束日期 (日期格式: 年-月-日), 區間:2022-01-01 至 2024-04-09', '2024-04-09')
if choice == '大台指期貨2024.12到期: 2023.12 至 2024.4.11':
    start_date = st.text_input('輸入開始日期(日期格式: 年-月-日), 區間:2023-12-21 至 2024-04-11', '2023-12-21')
    end_date = st.text_input('輸入結束日期 (日期格式: 年-月-日), 區間:2023-12-21 至 2024-04-11', '2024-04-11')
if choice == '小台指期貨2024.12到期: 2023.12 至 2024.4.11':
    start_date = st.text_input('輸入開始日期(日期格式: 年-月-日), 區間:2023-12-21 至 2024-04-11', '2023-12-21')
    end_date = st.text_input('輸入結束日期 (日期格式: 年-月-日), 區間:2023-12-21 至 2024-04-11', '2024-04-11')
if choice == '英業達2020.1.2 至 2024.4.12':
    start_date = st.text_input('輸入開始日期(日期格式: 年-月-日), 區間:2020-01-02 至 2024-04-12', '2020-01-02')
    end_date = st.text_input('輸入結束日期 (日期格式: 年-月-日), 區間:2020-01-02 至 2024-04-12', '2024-04-12')
if choice == '堤維西2020.1.2 至 2024.4.12':
    start_date = st.text_input('輸入開始日期(日期格式: 年-月-日), 區間:2020-01-02 至 2024-04-12', '2020-01-02')
    end_date = st.text_input('輸入結束日期 (日期格式: 年-月-日), 區間:2020-01-02 至 2024-04-12', '2024-04-12')
